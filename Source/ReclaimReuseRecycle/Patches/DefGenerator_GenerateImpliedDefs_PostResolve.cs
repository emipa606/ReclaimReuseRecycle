...
internal class DefGenerator_GenerateImpliedDefs_PostResolve
{
    [HarmonyPostfix]
    public static void Postfix()
    {
        ...
        foreach (var filter in new[]
                 {
                     R3DefOf.R3_AllowUnharvested_Primitive, R3DefOf.R3_AllowUnharvested_Advanced,
                     R3DefOf.R3_AllowUnharvested_Glittertech
                 })
        {
